...
import {revokeOrder, getDebtHistory} from '../../utils/redux/actions/adminSlice'
...
const Debt = () => {
    ...
    const orders = useSelector(state => state.admin.debtHistory)
    const admin = useSelector(state => state.admin.admin)
    const revokedOrder = useSelector(state => state.admin.revokedOrder)
